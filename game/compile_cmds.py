...
def read_cmd_def(def_filename, content, classes):
    idx = None
    lines = open(def_filename, "r").readlines()
    ...
    for line in lines:
        ...
        if m.group(1) == "DURATIVE":
            ...
            override_cleanup = "    bool cleanup(const GameEnv& env, CmdReceiver*) override;"
        ...
        elif m.group(1) == "CONTROL":
            baseclass = "CmdControl"
            override_run = "    bool run(GameEnv* env, CmdReceiver *) override;"
            override_cleanup = "";
        ...
        symbols = dict(
            ...
            override_cleanup = override_cleanup,
            enum_name = enum_name,
            classname = classname,
